...
export default function RaspadinhasPage() {
  ...
  const PrizesModal = ({ raspadinha }: { raspadinha: Raspadinha }) => (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-neutral-700 rounded-2xl p-6 w-full max-w-2xl border border-neutral-600 max-h-[80vh] overflow-y-auto scrollbar-thin scrollbar-track-neutral-800 scrollbar-thumb-purple-600 hover:scrollbar-thumb-purple-500 scrollbar-thumb-rounded-full scrollbar-track-rounded-full">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-white">{raspadinha.title} - Prêmios</h2>
          <button onClick={() => setShowPrizes(null)} className="text-gray-400 hover:text-white transition-colors">
            <X className="h-6 w-6" />
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {raspadinha.prizes.map((prize) => (
            <div key={prize.id} className="bg-neutral-600/50 rounded-lg p-4 border border-neutral-500">
              <img
  ...
  return (
    <div className="min-h-screen bg-neutral-600 pt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-neutral-700/50 rounded-xl p-6 mb-8 border border-neutral-600">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-neutral-600 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:border-purple-500 focus:outline-none"
              />
            </div>
            ...
            <select
              ...
              className="px-4 py-2 bg-neutral-600 border border-gray-600 rounded-lg text-white focus:border-purple-500 focus:outline-none appearance-none cursor-pointer"
              style={{
              ...
              >
                ...
                <div className="space-y-4 mb-6">
                  <div>
                    ...
                    <p className="text-xl font-bold text-yellow-500">{formatCurrency(card.maxPrize)}</p>
                  </div>
        ...
        {viewMode === "list" && (
          <div className="space-y-4">
            {filteredAndSortedRaspadinhas.map((card) => (
              <div
                key={card.id}
                className="bg-neutral-700/50 border border-neutral-600 rounded-xl p-6 hover:border-purple-500/30 transition-all duration-300"
              >
                <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-center">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-yellow-500">{formatCurrency(card.maxPrize)}</p>
                  </div>
                  ...
                  <div className="flex space-x-2">
                    ...
                    <button
                      onClick={() => setShowPrizes(card.id)}
                      className="px-4 py-2 border border-gray-600 hover:border-purple-500 text-gray-300 hover:text-purple-500 font-medium rounded-lg transition-colors"
                    >
                      Ver Prêmios
                    </button>
                  </div>
        ...
        {filteredAndSortedRaspadinhas.length === 0 && (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Nenhuma raspadinha encontrada</h3>
            <p className="text-gray-400 mb-6">Tente ajustar os filtros ou buscar por outro termo</p>
            <button
              onClick={() => {
