...
export default function TurboPage() {
  ...
  const gamePrice = 15.0
  const boostPrice = gamePrice * 2

  const prizes: Prize[] = [
    { id: "1", name: "R$ 5.000 em Dinheiro", value: 5000, image: "/scattered-currency.png", symbol: "💰" },
    { id: "2", name: "iPad Pro", value: 3000, image: "/ipad-on-desk.png", symbol: "📱" },
    { id: "3", name: "MacBook Air", value: 4000, image: "/modern-laptop-workspace.png", symbol: "💻" },
    { id: "4", name: "R$ 1.000 em Dinheiro", value: 1000, image: "/scattered-currency.png", symbol: "💵" },
    { id: "5", name: "iPhone 15", value: 2500, image: "/modern-smartphone.png", symbol: "📱" },
    { id: "6", name: "R$ 500 em Dinheiro", value: 500, image: "/scattered-currency.png", symbol: "💸" },
  ]

  const liveWinners = [
    { name: "Alexandre M.", prize: "R$ 5.000", time: "30 seg atrás" },
    { name: "Beatriz S.", prize: "iPad Pro", time: "2 min atrás" },
    { name: "Carlos R.", prize: "R$ 2.500", time: "5 min atrás" },
    { name: "Diana L.", prize: "MacBook Air", time: "8 min atrás" },
  ]

  const initializeGame = () => {
    const newCards: ScratchCard[] = []
    const baseWinChance = 0.22 // 22% base chance
    const actualWinChance = boostActive ? baseWinChance + 0.2 : baseWinChance
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">Turbo Cash</h1>
              <p className="text-gray-400">Raspadinha de R$ 15,00 • Prêmios de até R$ 5.000</p>
            </div>
          </div>
          {isLoggedIn && (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            {/* Scratch Cards */}
            <div className="bg-neutral-700/50 rounded-2xl p-6 border border-neutral-600 mb-6 relative">
              {!isLoggedIn && (
              ...
              <div className="grid grid-cols-3 gap-4 max-w-md mx-auto">
                {cards.map((card) => (
                  <div
                    ...
                    className={`aspect-square bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl flex items-center justify-center text-4xl cursor-pointer transition-all duration-300 ${
