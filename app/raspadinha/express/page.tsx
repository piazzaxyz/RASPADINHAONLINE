...
export default function ExpressPage() {
  ...
  const prizes: Prize[] = [
    { id: "1", name: "R$ 500 em Dinheiro", value: 500, image: "/scattered-currency.png", symbol: "💰" },
    { id: "2", name: "Smartphone", value: 400, image: "/modern-smartphone.png", symbol: "📱" },
    { id: "3", name: "Tablet", value: 300, image: "/modern-tablet-display.png", symbol: "📱" },
    { id: "4", name: "R$ 100 em Dinheiro", value: 100, image: "/scattered-currency.png", symbol: "💵" },
    { id: "5", name: "Smartwatch", value: 200, image: "/modern-smartwatch.png", symbol: "⌚" },
    { id: "6", name: "R$ 50 em Dinheiro", value: 50, image: "/scattered-currency.png", symbol: "💸" },
  ]

  const liveWinners = [
    { name: "Pedro R.", prize: "R$ 500", time: "1 min atrás" },
    { name: "Lucia M.", prize: "Smartphone", time: "4 min atrás" },
    { name: "Roberto S.", prize: "R$ 200", time: "7 min atrás" },
    { name: "Fernanda L.", prize: "Tablet", time: "10 min atrás" },
  ]

  const initializeGame = () => {
    const newCards: ScratchCard[] = []
    const baseWinChance = 0.18 // 18% base chance
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">Express Winner</h1>
              <p className="text-gray-400">Raspadinha de R$ 3,00 • Prêmios de até R$ 500</p>
            </div>
          </div>
          {isLoggedIn && (
              ...
              <div className="grid grid-cols-3 gap-4 max-w-md mx-auto">
                {cards.map((card) => (
                  <div
                    ...
                    className={`aspect-square bg-gradient-to-br from-orange-500 to-red-600 rounded-xl flex items-center justify-center text-4xl cursor-pointer transition-all duration-300 ${
